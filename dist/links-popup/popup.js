...
const shortUUID = /* @__PURE__ */ getDefaultExportFromCjs(shortUuid);
var DefaultContext = {
  color: void 0,
  size: void 0,
  className: void 0,
...
function PiCopySimpleLight(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 256 256", "fill": "currentColor" }, "child": [{ "tag": "path", "attr": { "d": "M184,66H40a6,6,0,0,0-6,6V216a6,6,0,0,0,6,6H184a6,6,0,0,0,6-6V72A6,6,0,0,0,184,66Zm-6,144H46V78H178ZM222,40V184a6,6,0,0,1-12,0V46H72a6,6,0,0,1,0-12H216A6,6,0,0,1,222,40Z" }, "child": [] }] })(props);
}
...
function RiDeleteBin6Line(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 24 24", "fill": "currentColor" }, "child": [{ "tag": "path", "attr": { "d": "M7 4V2H17V4H22V6H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V6H2V4H7ZM6 6V20H18V6H6ZM9 9H11V17H9V9ZM13 9H15V17H13V9Z" }, "child": [] }] })(props);
}
const Link = ({
  label,
  value,
  ...
  return isEditable || editAll ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "link", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        autoFocus: index === 0,
        placeholder: "Label",
        onChange: (e) => onLabelChange(id2, e.target.value)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        ...
        onClick: () => onDeleteLink(id2),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(RiDeleteBin6Line, {})
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        name: id2,
        value,
        onChange: (e) => onLinkChange(id2, e.target.value)
      }
    ),
    isEditable && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onLinkEditChange(id2), children: "done" })
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "link link-copy", onClick: () => onCopy(id2, value), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        ...
        children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          "copied ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(HiCheckCircle, {})
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(PiCopySimpleLight, { "data-copy": "copy-icon" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "link-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: value, target: "_blank", children: value }) })
  ] });
};
const App = () => {
  ...
  const [copiedLink, setCopiedLink] = reactExports.useState(null);
  ...
  const handleLinkChange = (id2, value) => {
    updateLinks(
      links.map((link) => link.id === id2 ? { ...link, value } : link)
    );
  };
  const handleLabelChange = (id2, label) => {
    updateLinks(
      links.map((link) => link.id === id2 ? { ...link, label } : link)
    );
  };
  const handleCopy = (id2, value) => {
  ...
  const addLink = () => {
    const id2 = shortUUID.generate();
    const newLink = { id: id2, label: "", value: "", isEditable: true };
    updateLinks([newLink, ...links]);
  };
  const handleEditLinkChange = (id2) => {
    updateLinks(
      links.map((link) => {
        if ((link == null ? void 0 : link.value) === "" || (link == null ? void 0 : link.label) === "") {
          return link.id === id2 ? {
            ...link,
            label: "Linkedin",
        ...
        return link.id === id2 ? { ...link, isEditable: false } : link;
      })
    );
  };
  const deleteLink = (id2) => {
    const newLinks = links.filter((link) => link.id !== id2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      ...
      links.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon edit-icon", onClick: handleEditDone, children: edit ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaCheck, { "data-done": "save" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FiEdit2, { "data-edit": "edit" }) })
    ] }),
    links.map((link, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        ...link,
        index,
